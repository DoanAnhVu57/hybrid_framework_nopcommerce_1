...
public class Level_01_Register_RY {
	...
	public void TC_04_Register_Existing_Email() {
		driver.findElement(By.cssSelector("a.ico-register")).click();
		  ...
		  Assert.assertEquals(driver.findElement(By.cssSelector("div.page-body ul")).getText(), "The specified email already exists");
	...
	@Test
	  ...
	  public void TC_06_Register_Invalid_Comfirm_Password() {
		  ...
		  Assert.assertEquals(driver.findElement(By.cssSelector("span.field-validation-error")).getText(), "The password and confirmation password do not match.");
