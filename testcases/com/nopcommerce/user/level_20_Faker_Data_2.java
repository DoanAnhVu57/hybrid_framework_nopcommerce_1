...
public class level_20_Faker_Data_2 extends BaseTest {
	...
	public void beforeClass(String browserName) {
		...
		firstName = UserData2.Register.FIRST_NAME;
		lastName = UserData2.Register.LAST_NAME;
		emailAddress = UserData2.Register.EMAIL_ADDRESS + generateFakeNumber() + "@gmail.vn";
		password = UserData2.Register.PASSWORD;
		Day = UserData2.Register.DATE;
		month = UserData2.Register.MONTH;
		year = UserData2.Register.YEAR;
	}
